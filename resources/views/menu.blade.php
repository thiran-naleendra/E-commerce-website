                                            ...
                                            <div class="menu_item">
                                                <figure>
                                                    <a href="img/menu_items/large/1.jpg" title="Soft shell crab"
                                                        ...
                                                        <img src="{{ asset('uploads/menus/' .$st->image) }}"
                                                            data-src="{{ asset('uploads/menus/' .$st->image) }}" class="lazy"
                                                            alt="">
                                                    </a>
                                                </figure>
                                            ...
                                            <div class="menu_item">
                                                <figure>
                                                    <a href="img/menu_items/large/7.jpg" title="Prime Rib"
                                                        data-effect="mfp-zoom-in">
                                                        <img src="{{ asset('uploads/menus/' .$Pa->image) }}" 
                                                            data-src="{{ asset('uploads/menus/' .$Pa->image) }}"  class="lazy"
                                                            alt="">
                                                    </a>
                                                </figure>
                                                <div class="menu_title">
                                                ...
                                                <div class="menu_item">
                                                    <figure>
                                                        <a href="img/menu_items/large/3.jpg" title="Summer Berry"
                                                            data-effect="mfp-zoom-in">
                                                            <img src="{{ asset('uploads/menus/' .$Ju->image) }}"
                                                                data-src="{{ asset('uploads/menus/' .$Ju->image) }}" class="lazy"
                                                                alt="">
                                                        </a>
                                                    </figure>
                                                    <div class="menu_title">
