            ...
            <div class="row">
              <div class="col-sm-3">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" placeholder="Enter menu name" name="name" id="item_no">
                </div>
              </div>
              <div class="col-sm-3">
                <div class="form-group">
                  <label>Item Code</label>
                  <input type="text" class="form-control" placeholder="Enter menu code" name="code" id="item_no">
                </div>
              </div>
              <div class="col-sm-3">
                <div class="form-group">
            ...
            <div class="row">
              <div class="col-sm-3">
                <div class="form-group">
                  ...
                  <input type="tel" name="description" id="description" placeholder="Enter description">
                </div>
              </div>
              <div class="col-sm-3">
                <div class="form-group">
                  <label>Image</label>
                  <input type="file" name="image" id="image" placeholder="Choose image for menu">
                </div>
              </div>
            </div>
            <div class="form-group">
                ...
                <table class="table table-striped table-bordered" id="dataTabl">
                  ...
                  @foreach($Menu as $menu)
                    <tr>
                      ...
                      <td style="text-align: center;"><img src="{{ asset('uploads/menus/' .$menu->image) }}" width= '60' height='60' class="img img-responsive" /></td>
                      <td>
                        <div class="row">
                          <div class="col">
                            <a href="{{ route('menu_update', ['id' => $menu->id]) }}" class="btn btn-default btn-sm btn-flat"
