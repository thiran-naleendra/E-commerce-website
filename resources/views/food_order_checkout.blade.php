                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select name="dog-names" id="dog-names" class="form-control"> 
                                            <option value="pumpernickel"><--Select--></option> 
                                            @foreach ( $area as $area )
                                            <option value="pumpernickel">{{$area ->area_name}}</option> 
                                            @endforeach
                        ...
                        <div class="main">
                            ...
                            <div class="payment_select">
                                <label class="container_radio">Pay with Cash
                                    <input type="radio" value="" name="payment_method" checked>
                                    <span class="checkmark"></span>
                                </label>
                ...
                <div class="col-xl-4 col-lg-4" id="sidebar_fixed">
                    <div class="box_booking">
                        ...
                        <div class="main">
                            ...
                            @endif
                            <a href="confirm.html" class="btn_1 full-width mb_5">Place Order Now</a>
